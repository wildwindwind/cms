...
<div class="left">
	...
	<div class="left_title"><i class="icons"></i><span>流程管理</span></div>
	<ul class="side">
	   <li><a href="${ctx}/admin/snaker/task/active.do" target="iframe" <#if (childMenu_index==0)>class="selected"</#if>>我的待办</a></li>
	   <li><a href="${ctx}/admin/snaker/flow/order.do" target="iframe" <#if (childMenu_index==0)>class="selected"</#if>>流程实例</a></li>
	   <li><a href="${ctx}/admin/snaker/process/list.do" target="iframe" <#if (childMenu_index==0)>class="selected"</#if>>流程定义</a></li>
	   <li><a href="${ctx}/admin/snaker/task/history.do" target="iframe" <#if (childMenu_index==0)>class="selected"</#if>>历史任务</a></li>
	   <li><a href="${ctx}/admin/snaker/surrogate/list.do" target="iframe" <#if (childMenu_index==0)>class="selected"</#if>>委托授权</a></li>
	</ul>
</div>
